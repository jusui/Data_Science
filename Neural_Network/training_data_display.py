...
class NeuralNetwork:
    ...
    # w_in = [[0.496, 0.512], [-0.501, 0.998], [0.498, -0.502]] # (3 * 2)入力層[0,1,2] - 中間層[0, 1, 2]
    # w_out = [0.121, -0.4996, 0.200] # (3 * 1)中間層 - 出力層
    w_in = [[0.512, 0.496], [0.998, -0.501], [-0.502, 0.498]] # (3 * 2)入力層[0,1,2] - 中間層[0, 1, 2]
    w_out = [-0.4996, 0.220, 0.121] # (3 * 1)中間層 - 出力層
